...
# 28 "main.c" 2
# 37 "main.c"
uint8_t contador = 123, cod = 0;
uint8_t vector[3] = {0,0,0};


void codificar_7seg(uint8_t valor, uint8_t* cod){
    switch(valor){
        case 0:
            cod = 0b00111111;
            break;
...
void multiplexado(void){
    ...
    if(PORTD <= 4){
        switch(PORTD){
        case 0:
            codificar_7seg(vector[2], cod);
            PORTC = cod;
            break;
        case 1:
            codificar_7seg(vector[1], cod);
            PORTC = cod;
            break;
        case 2:
            codificar_7seg(vector[0], cod);
            PORTC = cod;
            break;
        default:
            break;
